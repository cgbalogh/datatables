...
class FlexFormUserFunc {
    ...
    * @param array $fConfig
     * 
     * thsi method reads the autoregistered classes from
    *
    * @return void
    */
...
echo " A $tableName g $childTableName c $propertyName c B ";
...
echo " $childTableName :: $childClassName ";
            if ($reflection) {
